...
manhattan(infileall, ylim=c(0,200), col = c("firebrick1", "black"), cex = 0.6, suggestiveline = T, genomewideline = T, main = "Manhattan Plot of Total x CSRV", annotatePval = pvalue)
#highlight = newdata
